  ...
  render() {
    ...
    return (
      <View
          ...
          <AnimatedIcon
            ...
            style={{
              ...
              bottom: focusedAnim.interpolate({
                ...
                outputRange: [14, ANIM_PATH, NEGATIVE_ANIM_PATH, NEGATIVE_ANIM_PATH, 14],
              }),
        ...
        />
        {this.props.showClose && this.state.value && this.state.focus ? (
          <Touchable
            style={styles.close}
            onPress={() => {
              this.props.clear();
            }}>
            <Icon name="close1" size={20} color="#bbb" />
          </Touchable>
        ) : null}
      </View>
    );
